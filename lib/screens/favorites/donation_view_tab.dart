...
class DonationViewTab extends StatefulWidget {
  final String userId;

  const DonationViewTab({ this.userId });

  @override
  _DonationViewTabState createState() => _DonationViewTabState();
}

class _DonationViewTabState extends State<DonationViewTab> {
